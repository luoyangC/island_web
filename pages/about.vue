<template>
  <v-layout column>
        ...
        <v-card flat>
          ...
          <v-card-text>
            <ul>
              ...
              <li>未来发展目标是成为一名全栈工程师，目前积极寻找实习机会</li>
            </ul>
          </v-card-text>
        </v-card>
      </v-flex>
        ...
        <v-card flat>
          ...
          <v-card-text>
            <ul>
              ...
              <li>前端使用Nuxt.js构建，后端使用Python的Django构建，数据库使用Mysql，缓存使用Redis，服务器使用Nginx</li>
              <li>整个项目通过Docker打包上线，所有源代码都以同步到我的 <a href="https://github.com/luoyangC">Github</a></li>
            </ul>
          </v-card-text>
        </v-card>
      </v-flex>
    ...
    <!-- 底部导航 -->
    <page-bottom prev="/message" next="/inspire" prev-name="留言" next-name="文章" />
  </v-layout>
</template>
